 ...
 */
class Fornecedor extends \Vendas\Entity\Fornecedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'codFornecedor', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'cnpj', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'nome', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'telefone', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'email', '' . "\0" . 'Vendas\\Entity\\Fornecedor' . "\0" . 'stAtivo'];
        }
    ...
    public function getCodFornecedor()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCodFornecedor();
        }
