 ...
 */
class Categoria extends \Vendas\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Vendas\\Entity\\Categoria' . "\0" . 'codCategoria', '' . "\0" . 'Vendas\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'Vendas\\Entity\\Categoria' . "\0" . 'stAtivo'];
        }
    ...
    public function getCodCategoria()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCodCategoria();
        }
